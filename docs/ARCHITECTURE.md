...
- **v1.2 design (in progress):** unified persisted `PersistedInspectEvent` proposal — [proposals/UNIFIED-PERSISTED-INSPECT-EVENT.md](./proposals/UNIFIED-PERSISTED-INSPECT-EVENT.md). Implementation chunks: [implementation/CURSOR-MAINTAINER-ROADMAP.md](./implementation/CURSOR-MAINTAINER-ROADMAP.md). No runtime change until PR 2+.
