...
branch: "main"
lastConfirmedCommit: "6ee373c365e8dd6acbba20a191f89eff646e4564"
lastValidationLevel: "check-cli-and-configuration-chunk-gate"
completedChunks:
  - "v1.6.0-published"
  - "v1.7.0-published"
...
currentChunk: "v1.8-14-baseline-regression"
pendingManualGate: "openai-agents-first-publication-at-release"
nextAction: "Execute v1.8 chunk 14: add structural baseline regression checks for tree divergence, tools, LLMs, models/providers, tokens, duration, retries, status, error paths, retrieval, and guardrails while ignoring nondeterministic text by default"
