...
currentChunk: "v4.2-3 CLI subcommands (latest, activity, show, handoffs, errors)"
nextAction: "v4.2-3: extend packages/cli/src/sessions.ts with new subcommands + JSON output + tests"
