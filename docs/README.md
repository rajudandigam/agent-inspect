...
**Current release:** [agent-inspect@6.28.0](https://www.npmjs.com/package/agent-inspect) (eighteen linked packages) · schema **1.0** · Node.js **≥ 20** · **MIT** · **actively maintained**.
...
| [COMPATIBILITY-AI-SDK-MATRIX.md](./COMPATIBILITY-AI-SDK-MATRIX.md) | Isolated AI SDK 6/7 peer smoke |
