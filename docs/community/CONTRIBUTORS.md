...
| @abhay-codes07 | Core / docs / fixtures | HTML report duplicate attributes fix ([#78](https://github.com/rajudandigam/agent-inspect/pull/78)), retry/circuit fixture pack ([#79](https://github.com/rajudandigam/agent-inspect/pull/79)), log ingest cookbook ([#80](https://github.com/rajudandigam/agent-inspect/pull/80)), COMPARE.md refresh ([#81](https://github.com/rajudandigam/agent-inspect/pull/81)), list summary count fix ([#83](https://github.com/rajudandigam/agent-inspect/pull/83)) | 2026-07 |
