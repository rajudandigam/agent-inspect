...
| `llm-tokens-and-streaming.jsonl` | LLM input/output/total/cached `tokenUsage` + streaming `attributes` (see [TRACE-VOCABULARY-V1.5.md](../../docs/proposals/TRACE-VOCABULARY-V1.5.md)) |
